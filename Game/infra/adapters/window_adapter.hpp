...
public:
    ...
    IWindow &withTitle(std::string title) noexcept override;
    ...
    [[nodiscard]] const ViewportAdapter &getDynamicViewport() const noexcept override;
    [[nodiscard]] const ViewportAdapter &getDefaultViewport() const noexcept override;
    [[nodiscard]] const ViewportAdapter &getCurrentViewport() const noexcept override;
    [[nodiscard]] const VectorAdapter getCoords(
        const VectorAdapter &vector, const ViewportAdapter &viewport) const noexcept override;

    void close() noexcept override;
    void clear() noexcept override;
    void display() noexcept override;
    void dispatchEvents() noexcept override;
    void renderSync(IDrawable &drawable) noexcept override;
};
#endif
